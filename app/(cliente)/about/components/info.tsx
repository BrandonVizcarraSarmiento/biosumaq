...
const Info = () => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-4 justify-items-center py-20">
            <div className="flex flex-col items-center text-center space-y-4">
                <Image src="/img/mision.svg" width={300} height={300} alt="imagen de misión" className="h-64 w-64" />
            ...
            <div className="flex flex-col items-center text-center space-y-4">
                <Image src="/img/vision.svg" width={300} height={300} alt="imagen de visión" className="h-64 w-64" />
                <p className="text-base px-4 md:px-8 text-justify">
